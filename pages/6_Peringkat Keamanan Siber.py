...
y = [79.22, 71.43, 64.94, 63.64, 41.56, 38.96, 36.36, 18.18, 15.58, 10.39]
fig, ax = plt.subplots()
ax.bar(x, y, align='center')
ax.set_title('National Cyber Security Index (NCSI)')
ax.set_ylabel('Persentase')
ax.set_xlabel('Negara')

ax.set_xticks(x)
ax.set_xticklabels(("Malaysia", "Singapura", "Thailand", "Filipina", "Brunei Darussalam", "Indonesia", "Vietnam", "Laos", "Kamboja", "Myanmar"))
plt.show()
